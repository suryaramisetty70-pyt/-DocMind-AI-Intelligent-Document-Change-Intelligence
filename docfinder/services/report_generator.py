...
class ReportGenerator:
    ...
    def generate_pdf_report(comparison_result: Dict[str, Any], user_info: Dict[str, Any]) -> bytes:
        ...
        # Title
        story.append(Paragraph("DocFinder Comparison Report", title_style))
        ...
        story.append(Paragraph("<i>Generated by DocFinder - Intelligent Document Comparison Platform</i>", normal_style))
    ...
    def generate_excel_report(comparison_result: Dict[str, Any], user_info: Dict[str, Any]) -> bytes:
        ...
        ws_summary['A1'] = "DocFinder Comparison Report"
